...
\usepackage{geometry}
\geometry{a5paper,left=12mm,right=12mm,tmargin=15mm,bmargin=15mm,headsep=5mm}
\usepackage{float}
\usepackage{amsmath}
\usepackage{babel}
...
\begin{flushleft}
опубликовать свое релятивистсское волновое уравнение, оно уже было нез-
ависимо переоткрыто Оскаром Клейном [7] и Вальтером Гордоном [8]. По этой причине релятивистский вариант называется "уравнение Клейна-Го-
рдона".
\end{flushleft}
...
\end{equation}
% не \ref{formula0}, а (0) т.к. в документе нет этой формулы
...
\end{equation}
Решения уравнения (\ref{formula3}) с наложенными на них разумными граничными усл-
овиями, определяют уровни энергии [9]
% не \cite{link1}, а [9] т.к. в документе нет этого
\begin{equation}
